...
void Attacking::Enter(SoccerTeam* team)
{
  ...
  const int BlueRegions[TeamSize] = {1,12,6,4};
  const int RedRegions[TeamSize] = {16,3,5,9};
...
void Defending::Enter(SoccerTeam* team)
{
  ...
  //these define the home regions for this state of each of the players
  const int BlueRegions[TeamSize] = {1,6,8,5};
  const int RedRegions[TeamSize] = {16,9,12,14};
